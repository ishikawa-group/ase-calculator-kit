...
| **MatGL CHGNet** `matpes-pbe` | MatPES (temporary gradient correction; not retrained) | PBE, no Hubbard U | ✗ none | ✅ allowed — D3 `xc=pbe` |
| **MatGL CHGNet** `matpes-r2scan` | MatPES (temporary gradient correction; not retrained) | r2SCAN | ✗ none | ✅ allowed — D3 `xc=r2scan` |
